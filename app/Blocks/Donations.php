...
class Donations extends Block
{
     ...
     * @var string
     */
    public $description = 'Present donation options to the user.';
    ...
    public function fields(): array
    {
        ...
        $fields
            ...
            ->addText('donate_url', [
                'instructions' => 'The URL to the donation page.',
            ])
            ...
            ->addFlexibleContent('donations', [
                'layout' => 'block',
            ])
            ->addLayout('donation_item', [
                'label' => 'Item',
            ])
