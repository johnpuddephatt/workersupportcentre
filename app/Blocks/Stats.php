...
class Stats extends Block
{
     ...
     * @var string
     */
    public $description = 'Present key stats to the user.';
     ...
     * @var array
     */
    public $keywords = ['stats', 'statistics', 'numbers', 'key stats', 'key statistics', 'facts', 'impact'];
