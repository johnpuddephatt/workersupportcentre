<div class="wp-block {{ $block->classes }} {{ $block->style == 'alternative' ? 'bg-lime' : 'bg-mint' }}
{{ $block->block->align !== 'full' ? 'md:px-12' : '' }} overflow-hidden pr-4 pl-10  relative py-12 not-prose"
